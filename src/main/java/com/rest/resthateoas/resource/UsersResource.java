package com.rest.resthateoas.resource;

import com.rest.resthateoas.model.Users;
...
public class UsersResource {
    ...
    private Users getUser() {
        Users users = new Users("David", 2300L);
    ...
    public List<Users> getHateOASAll() {
        Users users1 = new Users("Shane", 2300L);
        Link link = ControllerLinkBuilder.linkTo(UsersResource.class)
        ...
        Users users2 = new Users("David", 2400L);
